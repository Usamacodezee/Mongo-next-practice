...
export default function DataTable() {
  ...
  const columns: GridColDef<UserTypes>[] = [
    ...
    { field: 'discountPercentage', headerName: 'Discount Percentage', width: 120 },
    { field: 'rating', headerName: 'Rating', width: 120 },
    { field: 'stock', headerName: 'Stock', width: 120 },
    { field: 'tags', headerName: 'Tags', width: 120 },
    { field: 'brand', headerName: 'Brand', width: 120 },
    { field: 'warrantyInformation', headerName: 'Warranty Information', width: 120 },
    { field: 'shippingInformation', headerName: 'Shipping Information', width: 120 },
    { field: 'availabilityStatus', headerName: 'Availability Status', width: 120 },
    { field: 'returnPolicy', headerName: 'Return Policy', width: 160 },
    { field: 'reviews.length', headerName: 'Reviews', width: 120 },
    { field: 'actions', headerName: 'Actions', width: 100 , editable:false, sortable:false, filterable: false},
  ];

  return (
    <Box sx={{ height: 400, width: '100%' }}>
      <DataGrid
        rows={Products.map((product: UserTypes) => ({ ...product, id: product._id }))}
        columns={columns}
        initialState={{
          pagination: {
